...
export function AuthorPrompt({ onSubmit }: AuthorPromptProps) {
  ...
  return (
    <footer className="bg-composer p-4">
      <h2 className="mb-2 text-center font-semibold text-white">What should we call you?</h2>
      ...
      <p className="mt-2 text-center text-xs text-white/80">
        Saved on this browser, so we can tell your messages apart from everyone else's.
      </p>
      {error && (
